...
public class PostCallTest extends TestBase {
	...
	public void postAPITest() throws JsonGenerationException, JsonMappingException, IOException{
		...
		mapper.writeValue(new File("/Users/jayas/Desktop/Selenium_WorkSpace/RestAPI/src/main/java/com/qa/data/users.json"), users);
		...
		//json to java object: unMARSHLING
